					...
					<Command>
						...
						<CommandList>
							...
							<CommandGroup className="p-0">
								{selectAllOption && (
									<CommandItem key="all" onSelect={toggleAll} className="cursor-pointer px-6">
										<div
											className={cn(
								...
								{options.map((option) => {
									...
									return (
										<CommandItem
											...
											className="cursor-pointer data-[selected='true']:bg-[#EFF5FF] rounded-none px-6"
										>
											<div
												className={cn(
													"mr-2 flex h-4 w-4 items-center justify-center rounded-sm border-2 border-[#0066FF]",
													isSelected
